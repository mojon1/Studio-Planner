...
await block('49', `LP（/about/）`, async () => {
  ...
  ok('every picture on the LP loads (meeting, plan, finder, pose, people, lights, scan, scanning, files, sheet, phone, icon)', imgs.length >= 6 && imgs.every(([, w]) => w > 0), JSON.stringify(imgs));
