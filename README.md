...
| 小道具 | 車（セダン・ワゴン・バン・軽）、椅子、テーブル、箱。すべて寸法可変。箱馬は 300×450×150 mm 固定で、平・横・縦に置き分け。箱・箱馬・テーブルの上には物を載せられ、箱馬どうしは積める |
...
| カット | 1 つの案件に複数カット。上のチップで切り替え、＋で今の配置を写して増やす。PDF は「このカットだけ」「全カット」を選べる |
...
**「オフラインに保存」**を押しておく。人物モデルを含めて 10 MB ほどを端末に控える。
